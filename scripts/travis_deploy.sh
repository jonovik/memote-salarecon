...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "jonovik/memote-salarecon" ]]; then
...
echo "Your new report will be visible at https://jonovik.github.io/memote-salarecon in a moment."
